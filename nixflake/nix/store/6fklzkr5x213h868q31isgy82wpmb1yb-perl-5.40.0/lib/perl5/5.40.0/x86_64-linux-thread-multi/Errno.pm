...
"x86_64\-linux\-thread\-multi-gnulinux" or
	die "Errno architecture (x86_64\-linux\-thread\-multi-gnulinux) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
